...
<div class="office">
    <div class="bid_header">
        <div class="bid_btn">
            <button><a href="#">مشاهدة جميع القضايا</a></button>
        </div>
        <div class="bid_title">
            <h1>القضايا</h1>
        </div>
            ...
            <div class="message_content">
                <div class="message_title">
                    <div class="message_btns">
                        <button><a href="{{ route('lawyerMessage.index') }}">فتح قضية</a></button>
                    </div>
                    <h2>القضايا</h2>
                </div>
                <div class="message_body">
                    <div class="message_bg">
                        ...
                        @foreach ($lawyerSends as $message)
                        <div class="message_body_title" style="background-color: {{ $message->read == 1 ? '#ffffff' : '#d6d6d6' }}">
                            ...
                            <!-- نهاية النموذج -->
                            <h3>
                                <a href="{{ route('lawyerMessage.view', ['lawyerMessage_id'=> $message->id]) }}" style="color: {{ $message->read == 1 ? '#5d9c40' : '#9b9b9b' }}">
                                    {{ $message->title }}
                                </a>
                            </h3>
                        </div>
